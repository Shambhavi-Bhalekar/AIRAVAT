  ...
  return (
    <div className="flex h-screen">
      <div 
        ...
        } bg-gradient-to-b from-blue-600 via-indigo-600 to-violet-600 text-white transition-all duration-300 ease-in-out flex flex-col justify-between shadow-lg`}>
        ...
        <div className="p-4 border-t border-indigo-700">
          <div className={`flex items-center ${isCollapsed ? 'justify-center' : 'justify-between'}`}>
            ...
            <Apple size={isCollapsed ? 24 : 20} className="text-red-400" />
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 bg-gray-50 p-8">
        ...
        <p className="text-gray-600 mt-2">Selected: {activeItem}</p>
        
        {activeItem === 'emergency' && (
          <div className="mt-4 bg-red-50 border border-red-200 rounded-lg p-4 text-red-700">
            <div className="font-bold">Emergency Services</div>
            <div className="mt-2">Call 911 for immediate medical assistance</div>
          </div>
        )}
      </div>
    </div>
