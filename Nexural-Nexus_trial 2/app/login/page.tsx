...
export default function Login() {
  ...
  const handleSubmit = (e) => {
    ...
    // Simulate api login/signup call
    setTimeout(() => {
      setIsLoading(false);
      if (formType === 'login') {
        ...
        // For registration, we'd typically do something different
        // But for demo, let's also move to step 2
        setStep(2);
      }
    }, 1500);
  };
  ...
  const handleContinue = () => {
    ...
    // Set timeout to simulate loading before redirect
    setTimeout(() => {
            ...
            {step === 2 && (
              <div className="glass-card bg-white/10 backdrop-blur-sm rounded-2xl p-8 transition-all shadow-xl border border-white/20 animate-fade-in flex flex-col items-center">
                ...
                <p className="text-blue-100 text-center mb-6">
                  {userType === 'patient' 
                    ? formType === 'login' ? "Welcome back to your health journey" : "Welcome to your health journey"
                    : formType === 'login' ? "Welcome back to your practice portal" : "Welcome to your practice portal"
                  }
                </p>
