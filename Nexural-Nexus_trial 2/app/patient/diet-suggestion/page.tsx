                ...
                <div className="space-y-6">
                  <div className="bg-white rounded-lg shadow-lg p-6">
                    ...
                    <div className="bg-blue-50 p-4 rounded mb-4">
                      ...
                      <p className="mb-3">{aiGeneratedPlan.healthAssessment?.summary || 'No assessment available'}</p>
                      <ul className="list-disc pl-5 space-y-1">
                        {aiGeneratedPlan.healthAssessment?.keyPoints?.map((point, index) => (
                          <li key={index} className="text-sm text-gray-700">{point}</li>
                        )) || <li className="text-sm text-gray-700">No key points available</li>}
                      </ul>
                    </div>
                  </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="bg-blue-50 p-4 rounded">
                        ...
                        <ul className="space-y-2">
                          ...
                          )) || <li className="text-gray-500 italic">No breakfast options available</li>}
                        </ul>
                      </div>
                      ...
                      <div className="bg-blue-50 p-4 rounded">
                        ...
                        <ul className="space-y-2">
                          ...
                          )) || <li className="text-gray-500 italic">No lunch options available</li>}
                        </ul>
                      </div>
                      ...
                      <div className="bg-blue-50 p-4 rounded">
                        ...
                        <ul className="space-y-2">
                          ...
                          )) || <li className="text-gray-500 italic">No dinner options available</li>}
                        </ul>
                      </div>
                      ...
                      <div className="bg-blue-50 p-4 rounded">
                        ...
                        <ul className="space-y-2">
                          ...
                          )) || <li className="text-gray-500 italic">No snack options available</li>}
                        </ul>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-white rounded-lg shadow-lg p-6">
                    ...
                    <div className="mb-4">
                      ...
                      <ul className="space-y-2">
                        ...
                        )) || <li className="text-gray-500 italic">No exercise recommendations available</li>}
                      </ul>
                    </div>
                    
                    <div>
                      <h4 className="font-medium text-blue-700 mb-2">Weekly Schedule</h4>
                      {aiGeneratedPlan.exercisePlan?.schedule ? (
                        ...
                        <p className="text-gray-500 italic">No weekly schedule available</p>
                      )}
                    </div>
                  </div>
                  ...
                  <div className="bg-white rounded-lg shadow-lg p-6">
                    ...
                    {aiGeneratedPlan.lifestyleAdjustments ? (
                      ...
                      <p className="text-gray-500 italic">No lifestyle adjustments available</p>
                    )}
                  </div>
