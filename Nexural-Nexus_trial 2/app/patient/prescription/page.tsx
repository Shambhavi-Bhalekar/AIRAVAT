...
import { Upload, X, FileText, Image, AlertCircle, Search, AlertTriangle, Check, Plus } from 'lucide-react';
                    ...
                    <ul className="space-y-2">
                      {processingResults.medications.map((med, index) => (
                        <li key={index} className="p-3 bg-gray-50 rounded-lg flex items-start">
                          ...
                          <div>
                            <p className="font-medium text-gray-800">{med.drug}</p>
                            {med.generic !== 'unknown' && med.generic !== med.drug && (
                      ...
                      {processingResults.medications.length === 0 && (
                        <li className="p-3 bg-gray-50 rounded-lg">
                          <p className="text-gray-600">No medications identified in the image.</p>
                        </li>
                      )}
                    </ul>
                  </div>
